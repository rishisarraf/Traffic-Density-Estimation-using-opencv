...
{    
    ...
    // some preprocessing needed for warpPerspective and cropping 
    ...
    //dynamic_density=queueDensity; //// comment this line after use
    auto stop = high_resolution_clock::now();
    write_csv("output.csv", queueDensity, dynamic_density);
